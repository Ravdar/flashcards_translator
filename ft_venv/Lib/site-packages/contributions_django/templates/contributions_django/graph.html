...
\*------------------------------------*/
  ...
  .cell {
    ...
    resize: none;
      ...
      {
      % if calendar.contributions_django.use_circles %
    }
...
<div class="panel panel-default">
  ...
  <div class="statistics row">
    <div class="col-md-12">
      <p class="annotation">Total contributions from {{ calendar.contributions_django.graph.start_date }}
        to {{calendar.contributions_django.graph.today_date}}</p>
      <p class="big_stat">{{ calendar.contributions_django.graph.sum }}</p>
    </div>
  </div>
</div>